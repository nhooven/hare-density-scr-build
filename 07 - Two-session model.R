...
# Here we'll run a two-session model, adding a "group" index to the
# data augmentation and pooling our model parameters

# wish me luck!

# groups will be denoted by g
# ultimately, we can recycle SITE-specific information
  # i.e., S, trap locations
  # but will want different strata by time t
  # not important here
